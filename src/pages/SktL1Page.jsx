...
import SummarySkt from '../components/skt_l1/SummarySkt'
import { useSKSearch } from '../hooks/useSKSearch'
import { DATASET_PATH_AKHIR_L1 } from '../utils/searchUtils'
import SkSearchControls from '../components/sk/SkSearchControls'
import SktResultsTable from '../components/skt_l1/SktResultsTable'
...
import SktLegendSection from '../components/skt_l1/SktLegendSection'
import { SUMMARY_TEXT } from '../config/constants'

export default function SktL1Page() {
  const {
    query,
    setQuery,
    searchMode,
    ...
    selectedJabatan,
    setSelectedJabatan,
  } = useSKSearch(DATASET_PATH_AKHIR_L1)
