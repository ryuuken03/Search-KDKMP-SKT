...
export default function SatdikFilter({
  selectedSatdik,
  setSelectedSatdik,
  satdikList = [],
  loading = false,
  ...
  // Total peserta yang dialokasikan ke satdik
  const totalSatdikParticipants = useMemo(() => {
    return satdikList.reduce((acc, curr) => acc + (curr.jumlah || 0), 0)
  }, [satdikList])

  // Filter list satdik berdasarkan pencarian di dalam dropdown
  ...
  return (
    <div className="satdik-filter" ref={containerRef}>
      <div className="satdik-filter__container">
        <label htmlFor="satdik-select-btn" className="satdik-filter__label">
            ...
            <div className="satdik-dropdown-menu" role="listbox" aria-label="Daftar SATDIK">
              <div className="satdik-dropdown-search">
                <input
                  ...
                  placeholder="Ketik untuk mencari SATDIK (67 lokasi)..."
                  value={searchTerm}
