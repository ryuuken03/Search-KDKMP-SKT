...
export default function SktResultsTable(props) {
  const renderRow = (r, i, indexOfFirstItem) => {
    const { error, noCol, nama, jabatanFormasi, pendidikan, status, status_sk, peringkat_sk, status_sebelum_l1, peringkat_sebelum_l1, status_sebelum_l2, peringkat_sebelum_l2, satdik, jabatan } = formatRowData(r, i, indexOfFirstItem)
