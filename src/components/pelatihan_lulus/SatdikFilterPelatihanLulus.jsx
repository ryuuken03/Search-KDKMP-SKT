...
import { IconChevron, IconClose } from '../common/Icons'
...
export default function SatdikFilterPelatihanLulus({
  selectedSatdik,
  setSelectedSatdik,
  satdikList = [],
  loading = false,
  ...
  return (
    <div className="satdik-filter" ref={containerRef}>
      <div className="satdik-filter__container">
        <label htmlFor="satdik-pelatihan-select-btn" className="satdik-filter__label">
        ...
        <div className="satdik-dropdown-wrapper">
          ...
          >
            <button
              id="satdik-pelatihan-select-btn"
              type="button"
