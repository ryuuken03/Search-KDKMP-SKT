...
export default function SktResultsTable(props) {
  const renderRow = (r, i, indexOfFirstItem) => {
    const { error, noCol, nama, jabatanFormasi, pendidikan, status, status_sk, peringkat_sk, status_sebelum_l1, peringkat_sebelum_l1, jabatan } = formatRowData(r, i, indexOfFirstItem)
