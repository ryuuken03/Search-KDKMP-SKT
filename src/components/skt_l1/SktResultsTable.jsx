...
const formatRowData = (r, i, indexOfFirstItem) => {
  ...
  return {
    ...
    status_sebelum_l1: vals[8] || '', // status sebelum l1
    peringkat_sebelum_l1: vals[9] || '', // peringkat sebelum l1
    jabatan: r.jabatan || '',
    error: r.error
  }
}
      ...
      <table>
        ...
        <tbody>
          {displayItems.map((r, i) => {
            const { error, noCol, peserta, nama, jabatanFormasi, pendidikan, status, status_sk, peringkat_sk, status_sebelum_l1, peringkat_sebelum_l1, jabatan } = formatRowData(r, i, indexOfFirstItem)
