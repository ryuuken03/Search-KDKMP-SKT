...
const data = JSON.parse(fs.readFileSync('assets/combined/akhir_layer_1/data.json', 'utf8'));

const chunksDir = 'assets/combined/akhir_layer_1/chunks';
const namesDir = 'assets/combined/akhir_layer_1/names';
...
fs.writeFileSync('assets/combined/akhir_layer_1/no_peserta.json', JSON.stringify(noPeserta));
fs.writeFileSync('assets/combined/akhir_layer_1/peringkat.json', JSON.stringify(peringkat));
